...
public class PeakRCounter implements Counter {
    ...
    private static final double[] n_template = {0.00982458380295,0.00929931113224,0.00896757155772,0.00901889910303,0.00898756692026,0.00897197420635,0.00876534323049,
    ...
    public void clear()
    {
        ...
        this.count = 0;
        this.listener.countChanged(count);
        this.incoming_count = 0;
        this.diff_queue.clear();
